...
public class BoardConfig {
   ...
   public int getIsModifiy() {
      return isModifiy;
   }
   
   public void setIsModifiy(int isModifiy) {
   ...
   public String toString() {
      return "BoardConfig [id=" + id + ", boardNm=" + boardNm + ", isUse=" + isUse + ", useEditor=" + useEditor
            + ", isModifiy=" + isModifiy + ", attachFileType=" + attachFileType + ", postsPerPage=" + postsPerPage
            + ", pageRanges=" + pageRanges + ", useComment=" + useComment + ", topHtml=" + topHtml + ", bottomHtml="
            + bottomHtml + ", regDt=" + regDt + ", modDt=" + modDt + "]";
   }
